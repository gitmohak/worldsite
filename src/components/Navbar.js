                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item me-4">
                                <a className="nav-link fs-5 fw-bold" aria-current="page" href="#myCarousel">Featured</a>
                            </li>
                            <li className="nav-item me-4">
                                <a className="nav-link fs-5 fw-bold" aria-current="page" href="#myHighlights">Highlights</a>
                            </li>
                            <li className="nav-item me-4">
